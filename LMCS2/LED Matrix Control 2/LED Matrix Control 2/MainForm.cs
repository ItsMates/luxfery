...
namespace LED_Matrix_Control_2
{
    public partial class MainForm : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            pbm = new PictureBoxManager(pixlx, pixly);
            ...
            //pbm.CreateBoxes(pixlx, pixly); //create matrix pictureboxes with loaded width and height
